"use strict";
var globeUrl='api/v1';
var Blog = angular.module('Blog', ['ngRoute', 'restangular','ngAnimate', 'LocalStorageModule','angularFileUpload',"ui.bootstrap","wu.masonry",'infinite-scroll',"textAngular"])
...
.config(function($routeProvider, RestangularProvider) {
    ...
    RestangularProvider.setBaseUrl(globeUrl);
 
    var partialsDir = './views';//调试后需改动
    ...
    $routeProvider
        ...
        .when('/works/:id', {
            ...
            templateUrl: partialsDir + '/home/works.html'
        })
